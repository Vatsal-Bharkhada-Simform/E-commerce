...
const buttonClassNames: Record<Variant, string> = {
	...
	PRIMARY:
		"flex justify-center items-center gap-2 bg-accent text-white cursor-pointer px-4 py-2 rounded-2xl text-md transition-all duration-300",
	SECONDARY:
		"flex justify-center items-center gap-2 bg-card text-text-main cursor-pointer px-4 py-2  border border-border rounded-2xl text-md transition-all duration-300",
	...
	DANGER: "bg-red-50 hover:bg-red-100 text-red-700 cursor-pointer px-4 py-1.5  border border-red-100 rounded-xl text-md transition-all duration-300",
};
